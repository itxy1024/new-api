...
export function collectWebSearchCalls(
  output: ResponsesOutputItem[] | undefined
): AgentWebSearchCallSummary[] {
  return (output ?? [])
...
export function getAgentRoundOutputItems(
