...
export function FavoriteCollectionsView() {
  ...
  const toggleFavoriteCollectionSelection = useStore(
    (s) => s.toggleFavoriteCollectionSelection
  )
  ...
  const cards = useMemo<CollectionCard[]>(() => {
    const allTasks = getCollectionTasks(
            ...
            return (
              ...
              >
                <FavoriteCollectionOverviewCard
                  ...
                  onToggleSelection={() =>
                    toggleFavoriteCollectionSelection(card.id)
                  }
