  ...
  if (showFavoriteCollectionBatchBar) {
    return (
      <div className='mb-3 flex justify-center'>
        <div className='pointer-events-auto flex items-center rounded-full border border-gray-200/50 bg-white/90 p-1 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur dark:border-white/10 dark:bg-gray-800/90 dark:shadow-lg'>
          <BatchActionButton
          ...
          <div className='mx-1 h-5 w-px bg-gray-200 dark:bg-white/20'></div>
          <BatchActionButton
            onClick={onSelectAllVisibleFavoriteCollections}
            className='p-2 text-blue-500 transition-colors hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300'
            tooltip='全选收藏夹'
          >
            <svg
              className='h-5 w-5'
          ...
          <BatchActionButton
            ...
            className='p-2 text-purple-500 transition-colors hover:text-purple-600 dark:text-purple-400 dark:hover:text-purple-300'
            tooltip='反选收藏夹'
          >
            <svg
              className='h-5 w-5'
          ...
          <BatchActionButton
            ...
            className='p-2 text-green-500 transition-colors hover:text-green-600 dark:text-green-400 dark:hover:text-green-300'
            tooltip='下载选中'
          >
            <svg
              className='h-5 w-5'
