...
export default function HelpModal({
  appMode,
  isFavoriteCollectionOverview = false,
  onClose,
}: HelpModalProps) {
              ...
              <section>
                <div className='space-y-4'>
                  <ul className='list-disc space-y-2 pl-4'>
                    ...
                    <li>
                      如需 Agent 搜索互联网或读取 URL 内容，可在设置的 Agent
                      配置中开启“网络搜索”。
                    </li>
                    <li>
                      输入{' '}
                      ...
                      可引用参考图或前面轮次生成的图片；Agent
                      也会自行参考上下文中的图片。
                    </li>
                    <li>
                      编辑某轮消息重新发送，或重新生成某轮消息，会产生可切换的分支。
                    </li>
                    <li>
                      生成的图片会同步到画廊；删除对话默认不会删除画廊中的任务。
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className='space-y-4'>
                  <p>
                    ...
                    、
                    <strong className='font-medium text-purple-500 dark:text-purple-400'>
                      反选收藏夹
                    </strong>
                    、
