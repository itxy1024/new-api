...
export default function SupportPromptModal() {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className='animate-modal-in relative z-10 flex w-full max-w-sm flex-col rounded-[2rem] border border-white/50 bg-white/95 p-6 pb-7 shadow-2xl ring-1 ring-black/5 dark:border-white/[0.08] dark:bg-gray-900/95 dark:ring-white/10'
