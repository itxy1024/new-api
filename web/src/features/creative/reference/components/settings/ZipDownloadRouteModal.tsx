...
export const ZIP_DOWNLOAD_ROUTE_OPTIONS: Array<{
...
export default function ZipDownloadRouteModal({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className='animate-confirm-in relative z-10 flex max-h-[85vh] w-full max-w-md flex-col rounded-3xl border border-white/50 bg-white/90 shadow-[0_8px_40px_rgb(0,0,0,0.12)] ring-1 ring-black/5 backdrop-blur-xl sm:max-h-[90vh] dark:border-white/[0.08] dark:bg-gray-900/90 dark:shadow-[0_8px_40px_rgb(0,0,0,0.4)] dark:ring-white/10'
      ...
      >
        ...
        <div
          ...
          className='custom-scrollbar min-h-0 flex-1 space-y-3 overflow-y-auto px-6 py-2'
        >
          {ZIP_DOWNLOAD_ROUTE_OPTIONS.map((option) => {
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-2xl border p-3.5 transition-colors focus:ring-2 focus:ring-blue-500/20 focus:outline-none ${isChecked ? 'border-blue-500/30 bg-blue-50/50 dark:border-blue-400/30 dark:bg-blue-500/[0.05]' : 'border-gray-100 bg-gray-50/70 hover:bg-gray-100/70 dark:border-white/[0.06] dark:bg-white/[0.03] dark:hover:bg-white/[0.05]'}`}
              >
