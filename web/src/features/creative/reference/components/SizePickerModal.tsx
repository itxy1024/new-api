...
const CODEX_CLI_SIZE_LIMIT_TEXT =
    ...
    >
      ...
      >
        ...
        <div className='space-y-6'>
          ...
          <div className='-mr-1 h-[380px] max-h-[55vh] scrollbar-thin scrollbar-thumb-gray-200 overflow-y-auto pr-1 pb-2 dark:scrollbar-thumb-white/10'>
            {mode === 'auto' && (
              <div className='animate-fade-in flex h-full items-center justify-center pt-8 pb-4 text-center'>
                <div>
                ...
                {ratio === 'custom' && (
                  <label className='animate-fade-in block'>
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border px-3 py-2 text-sm transition outline-none ${
                        customRatioValid
                  ...
                  <div className='flex items-center gap-4'>
                    <label className='flex-1'>
                      ...
                      <input
                        ...
                        className='w-full rounded-xl border border-gray-200/70 bg-white/60 px-3 py-2 text-sm text-gray-700 transition outline-none focus:border-blue-300 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200 dark:focus:border-blue-500/50'
                        placeholder='例如 1024'
                      />
                    </label>
            ...
            <div className='mt-1 flex items-center gap-2'>
              ...
              {isClamped && (
                ...
                >
                  ...
                  <ViewportTooltip
                    visible={hintVisible}
                    className='w-56 text-center whitespace-pre-line'
                  >
                    {CLAMPED_SIZE_TEXT}
                  </ViewportTooltip>
                </div>
